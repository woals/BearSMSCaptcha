		...
		switch (view.getId()) {
			case R.id.btn_next:
				...
				mCaptcha.sendCaptcha(phone, new ResultCallBack() {
					...
					public void onResult(int code, String reason, String result) {
						...
						Log.d("tag1","code:"+code+"reason:"+reason+"result:"+result);
						if(code == 0){
							//调用成功
						}
					}
			...
			case R.id.btn_submit:
				...
				mCaptcha.commitCaptcha(phoneNumber, code, new ResultCallBack() {
					...
					public void onResult(int code, String reason, String result) {
						// TODO Auto-generated method stub
						Log.d("tag2","code:"+code+"reason:"+reason+"result:"+result);
						if(code == 0){
							//短信验证成功
							Toast.makeText(MainActivity.this, "验证成功！！！！！！！！", Toast.LENGTH_LONG).show();
						}else{
							//验证失败
							Toast.makeText(MainActivity.this, "失败！！！！！！！！" +"rea:"+ reason+"res:"+result, Toast.LENGTH_LONG).show();
						}
